...
class AlignTool(AppShell):
    ...
    def __init__(self, list=[], parent=None, nodePath=None, **kw):
        ...
        self.nameBox = None
        self.alignXVar = None
        self.alignXButton = None
        self.alignHVar = None
        self.alignHButton = None
        self.alignYVar = None
        self.alignYButton = None
        self.alignPVar = None
        self.alignPButton = None
        self.alignZVar = None
        self.alignZButton = None
        self.alignRVar = None
        self.alignRButton = None
        self.alignSXVar = None
        self.alignSXButton = None
        self.alignSYVar = None
        self.alignSYButton = None
        self.alignSZVar = None
        self.alignSZButton = None
