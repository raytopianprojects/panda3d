...
class FileMgr:
    ...
    def saveToFile(self, fileName):
        try:
            ...
            f.write("objects = {}\n")
            f.write("animMgr.keyFramesInfo = " +
                    str(self.editor.animMgr.keyFramesInfo)+"\n")
            f.write("animMgr.curveAnimation = " +
                    str(self.editor.animMgr.curveAnimation)+"\n")
            ...
            self.editor.updateStatusReadout(
                'Sucessfully saved to %s' % fileName)
    ...
    def loadFromFile(self, fileName):
        ...
        try:
            ...
            self.editor.updateStatusReadout(
                'Sucessfully opened file %s' % fileName)
            self.editor.fNeedToSave = False
        except:
