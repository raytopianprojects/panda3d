...
objects['1252538687.73gjeon'] = objectMgr.addNewObject(
    'Smiley', '1252538687.73gjeon', 'models/smiley.egg', None)
if objects['1252538687.73gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252538687.73gjeon'])
    objectMgr.updateObjectProperties(objects['1252538687.73gjeon'], {
                                     '123': 1, 'Abc': 'a', 'Number': 1, 'Happy': True})

objects['1252538690.2gjeon'] = objectMgr.addNewObject(
    'H Double Smiley', '1252538690.2gjeon', None, objects['1252538687.73gjeon'])
if objects['1252538690.2gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252538690.2gjeon'])
    objectMgr.updateObjectProperties(objects['1252538690.2gjeon'], {
                                     'Distance': 2.0, 'Abc': 'a'})

objects['1252539696.69gjeon'] = objectMgr.addNewObject(
    'H Double Smiley', '1252539696.69gjeon', None, objects['1252538687.73gjeon'])
if objects['1252539696.69gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252539696.69gjeon'])
    objectMgr.updateObjectProperties(objects['1252539696.69gjeon'], {
                                     'Distance': 2.0, 'Abc': 'a'})

objects['1252539897.22gjeon'] = objectMgr.addNewObject(
    'H Double Smiley', '1252539897.22gjeon', None, objects['1252538687.73gjeon'])
if objects['1252539897.22gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252539897.22gjeon'])
    objectMgr.updateObjectProperties(objects['1252539897.22gjeon'], {
                                     'Distance': 2.0, 'Abc': 'a'})

objects['1252538689.13gjeon'] = objectMgr.addNewObject(
    'V Double Smiley', '1252538689.13gjeon', None, objects['1252538687.73gjeon'])
if objects['1252538689.13gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252538689.13gjeon'])
    objectMgr.updateObjectProperties(objects['1252538689.13gjeon'], {
                                     'Distance': 1.0, 'Abc': 'a'})

objects['1252539974.19gjeon'] = objectMgr.addNewObject(
    'Smiley', '1252539974.19gjeon', 'models/frowney.egg', objects['1252538689.13gjeon'])
if objects['1252539974.19gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 1.000000, 1.000000, 1.000000, objects['1252539974.19gjeon'])
    objectMgr.updateObjectProperties(objects['1252539974.19gjeon'], {
                                     '123': 1, 'Abc': 'a', 'Number': 1, 'Happy': True})

objects['1252623762.9gjeon'] = objectMgr.addNewObject(
    'Panda', '1252623762.9gjeon', None, None)
if objects['1252623762.9gjeon']:
    ...
    objectMgr.updateObjectColor(
        1.000000, 0.000000, 0.000000, 0.517647, objects['1252623762.9gjeon'])
